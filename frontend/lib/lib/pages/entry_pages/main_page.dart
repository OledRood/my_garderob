  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: (serverRequest == true)
          ? FutureBuilder(
              future: _serverRequest(_emailController.text, _passwordController.text),
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  ...
                  return Scaffold(backgroundColor: GarderobColors.background,body: Center(child: SizedBox(height: 30, width: 30, child: Icon(Icons.close))),);
                } else {
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                  ...
                  return Scaffold(backgroundColor: GarderobColors.background,body: Center(child: SizedBox(height: 30, width: 30, child: Icon(Icons.check))),);
                }
              })
          : Scaffold(
              backgroundColor: GarderobColors.background,
